...
public class ItemScript {	
	...
	public static void printDamage(int dice) {
		...
		System.out.println();
		strb.append(dice+" 의 피해를 줬습니다!!<br>");
	}
	...
	public static void printTakedDamage(int dice) {
		...
		System.out.println();
		strb.append(dice+" 의 피해를 받았습니다!!<br>");
	}
	...
	public static void printIncorrectDice() {
		...
		System.out.println();
		strb.append(" * 눈금이 맞지않아 발동되지 않습니다 *<br>");
	}	
